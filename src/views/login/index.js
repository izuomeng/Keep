...
const Input = styled
  ...
  .attrs({
    ...
    placeholder: props => props.type === 'text'
      ? props.placeholder
      : '',
    value: props => props.type === 'submit'
      ? props.name
      : ''
  })`
    width: 100%;
...
class Form extends Component {
  ...
  handleSubmit(event) {
    ...
    this
      .props
      .handleSubmit(this.state.username, this.state.userpass)
...
export default() => (<WrapperContainer name='登陆'/>)
